...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->brandName(function () {
                $appName = app(\App\Settings\GlobalSettings::class)->app_name ?? 'SET Intranet';
                try {
                    $instruments = app(\App\Settings\Modules\InstrumentsSettings::class);
                    return $appName . ' - ' . ($instruments->module_name ?? 'Merila') . ' (' . ($instruments->module_number ?? '70.001') . ')';
                } catch (\Throwable $e) {
                    return $appName . ' - Merila (70.001)';
                }
            })
            ...
            ->pages([
                ...
                \App\Filament\Pages\InstrumentsSettingsPage::class,
            ])
