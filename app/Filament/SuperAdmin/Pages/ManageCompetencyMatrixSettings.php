...
class ManageCompetencyMatrixSettings extends BaseSettingsPage
{
    protected static ?string $navigationIcon = 'heroicon-o-academic-cap';

    protected static string $settings = CompetencyMatrixSettings::class;

    protected static ?string $navigationLabel = 'Nastavitve Matrike Usposobljenosti';

    protected static ?string $title = 'Nastavitve MUS Matrike Usposobljenosti';

    protected static ?string $navigationGroup = 'Nastavitve';

    protected static ?int $navigationSort = 12;

    protected static ?string $slug = 'nastavitve/mus';
